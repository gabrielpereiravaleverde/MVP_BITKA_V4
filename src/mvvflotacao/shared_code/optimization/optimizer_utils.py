...
class OptunaResults:
    ...
    def plot_param(self, figsize = (30,10)):
...
class SimulationResults:
    ...
    def full_plot(self, figsize = (20, 10)):
        figsize = (figsize[0],  figsize[1] + max((0, (len(self.params) - 3) * 1.5)))
        fig, ax = plt.subplots(3, len(self.params), figsize = figsize)
        num_bins = 50
    ...
    def plot_decision_variable(self, figsize = (20,6)):
        figsize = (figsize[0],  figsize[1] + max((0, (len(self.params) - 3) * 1.5)))
        fig, ax = plt.subplots(1, len(self.params), figsize = figsize)
        for i, c in enumerate(self.params):
